...
function Autocomplete(_a) {
    ...
    react_1.useEffect(function () {
        if (value) {
            var filtered = locations.filter(function (location) {
                return location.english_name.toLowerCase().includes(value.toLowerCase()) ||
    ...
    return (React.createElement("div", { className: "relative", ref: containerRef },
        ...
        isOpen && !disabled && (React.createElement("div", { className: "absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto" }, filteredLocations.length === 0 ? (React.createElement("div", { className: "px-4 py-3 text-gray-500 text-center" }, "No locations found")) : (filteredLocations.map(function (location) { return (React.createElement("div", { key: location.short_code, onClick: function () { return handleSelect(location); }, className: "px-4 py-3 hover:bg-gray-50 cursor-pointer border-b border-gray-100 last:border-0" },
            React.createElement("div", { className: "flex items-center space-x-3" },
                React.createElement("div", { className: "w-8 h-8 bg-gray-100 rounded flex items-center justify-center" },
                    React.createElement("span", { className: "text-xs font-bold text-gray-600" }, location.short_code)),
                React.createElement("div", { className: "flex-1" },
                    React.createElement("div", { className: "font-medium text-gray-900" }, location.english_name),
                    React.createElement("div", { className: "text-sm text-gray-500" }, location.code_state))))); }))))));
}
